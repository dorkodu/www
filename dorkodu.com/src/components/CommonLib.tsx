...
import { ArrowList, Badge, IconTitle, ParagraphTagline } from "../../styles/elements";
...
export const People: FunctionComponent = () => {
  ...
  const members = {
    ...
    berra: {
      name: "berra uslu",
      title: "rookie",
      about: "freelance creative. illustrator, visual arts. social justice warrior.",
      icons: ["tabler:brush", "tabler:palette"],
    },
    aziz: {
      name: "aziz öçmaz",
      title: "rookie",
      about: "gamification apprentice, graphics design, media. gnome chieftain.",
  ...
  return (
    <div css={style.TheDorkoduWay} id="the-dorkodu-way">
      ...
      <p css={style.paragraph}>
        our culture is inspired by <i>emotions</i> which express&nbsp; the <i>vibe</i> of an authentic{" "}
        <em>life experience.</em>
      </p>
    </div>
  );
};
  ...
  return (
    <section id="motto">
      <div css={Motto}>
        ...
        <p>
          We are here to put the <i style={{ textDecoration: "underline" }}>meaning</i> back into the <i>products</i>{" "}
          and <i>technology</i> again.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <>
      ...
      <Hero
        ...
        head={<Icon icon="icon-park-twotone:brain" width={48} css={Badge.DuoTone} />}
        center
      >
        <p
          css={css`
        ...
        <article>
          <ol css={local.timelineList}>
            <li>
              ...
              <br />
              <em>Doruk</em> is an artistic kid and wants to be a leader & inventor.
            </li>
            <li>
              <em>Doruk</em> learns to code at <b>10</b>.<span>— he finally found his passion.</span>
            </li>
            <li>
              <b>Dorkodu</b>&apos;s seeds are planted during <b>2016</b>, when Doruk brands his all software under the
              name <i>dorkodu</i> (doruk + code).
              <span>
            ...
            <li>
              <em>Doruk</em> and <b>Berk</b> meet at <em>Vefa</em> in <em>2018</em>, instant best friends!
              <span>
                — <em>Berk</em> starts coding, after being an <em>international e-sports wonderkid</em>.
              </span>
            </li>
            <li>
              <em>Doruk</em> and <em>Berk</em> starts working together.
              <span>— doruk is engineering on web, berk is a game creator.</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span>
                — with <b>dorkodia</b>, an experimental social app for meditation & productivity.
              </span>
            </li>
            <li>
              <em>doruk and berk</em> publish their <em>open source</em> projects.
              <span>
                — complex <em>software libraries, protocols</em> and <em>frameworks</em>; even <em>pixelart.</em>
              </span>
            </li>
            <li>
              <em>dorkodu</em> focuses on <em>gamification</em>, <em style={{ textTransform: "uppercase" }}>AI</em> and{" "}
              <em>web 3.0</em>.
              <span>
            ...
            <li>
              <b>berra</b> and <b>aziz</b> join <em>the dorkodu revolution</em> as our first rookies.

<template>
  <footer class="footer">
    <div class="__wrapper">
      <div class="__uppersection">

        <div class="__brand">
          <div class="__logo">
            <svg version="1.1" viewBox="0 0 64.58 16.145" xmlns="http://www.w3.org/2000/svg"
              ...
              <g transform="translate(0 -200.21)">
                ...
                <g transform="matrix(.06458 0 0 .06458 0 200.21)" fill="#fff">
                  <path
                    ...
                    color="#000000" stroke-width="0" style="-inkscape-stroke:none" />
                  <path
      ...
      <div class="__subsection">
        <div class="__copyright">
          <p class="__statement"><b>&copy; 2022</b> — the dorkodu company.</p>
        </div>
      </div>
    </div>
  </footer>
...
.footer {
  ...
  border-top: 1rem solid $reference-color-gray-95;
  ...
  .__subsection {
    border-top: 2px solid $reference-color-gray-80;
    margin-top: 1.5rem;
  }
  ...
  .__nav {
    ...
    h4 {
      ...
      font-size: 1.25rem;
      margin-bottom: .5rem;
      border-bottom: .35rem solid $reference-color-gray-80;
      border-radius: 3px;
